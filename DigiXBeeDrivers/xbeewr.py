...
class XBeeWRN(XBeeDevice):
    """XBeeWRN - object representing a an XBee Wall Router device on the mesh.
    This object allows the configuration and use of an XBee Wall Router device."""
    
    def __init__(self, addr):
        """addr - IEEE 802.15.4 address of XBee Wall Router module."""
        
        XBeeDevice.__init__(self, addr)
        # Verify that device is truly a Wall Router Adapter
        if self.product_type != XBeeWallRouter:
